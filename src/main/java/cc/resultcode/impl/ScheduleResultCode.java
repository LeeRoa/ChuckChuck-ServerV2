...
/**
 * ScheduleResultCode 1300 ~ 1399 정의 (일정, 일정 그룹, 일정 그룹 멤버 등 일정과 관련된 코드만 정의)
 */
@Getter
public enum ScheduleResultCode implements ResultCodeType {
    /**
     * HTTP 상태 코드 정의
     */
    ...
    ScheduleResultCode(String resultCode, String resultMsg) {
