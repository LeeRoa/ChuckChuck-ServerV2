...
/**
 * NoticeResultCode 1200 ~ 1299 정의 (공지사항, 공지사항 댓글, 공지사항 관련 문서 등 공지사항과 관련된 코드만 정의)
 */
@Getter
public enum NoticeResultCode implements ResultCodeType {
    /**
     * HTTP 상태 코드 정의
     */
    ...
    NoticeResultCode(String resultCode, String resultMsg) {
